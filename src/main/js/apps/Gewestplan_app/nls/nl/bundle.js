define(
    ({
        ...
        search: {ui: {placeHolder: "Adres, co\u00F6rdinaat", noValue: "Geen waarde", searchTypes: {GEOLOCATOR: "adres"}, noResult: "Niet gevonden. Probeer opnieuw."}, defaultInfoTemplate: {title: "Zoekresultaat", content: "${title}"}},
