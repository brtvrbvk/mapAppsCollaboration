define(
    ({
        ...
        mapModelBuilderWidget: {
            ...
            restUrl: "REST service URL (only for themainfo)",
            restUrlTooltip: "REST service URL (only for themainfo) e.g. http://geo.agiv.be/ArcGIS/rest/services/Bodemgebruik/MapServer",
            restTitleAttribute: "Attribute to retrieve title (only for themainfo, optional)",
            restTitleAttributeTooltip: "Attribute to retrieve title (only for themainfo, optional)",
            restLayerId: "Layer ID to use (only for themainfo, numeric)",
            restLayerIdTooltip: "Layer ID to use (only for themainfo, numeric)",
            ...
            defaultEnabledLayer: "Layer enabled on startup:",
            defaultEnabledTooltip: "Check to set category to be enabled on startup of the app.",
            defaultEnabledLayerTooltip: "Check to set layer to be enabled on startup of the app.",
            ...
            metadataUrlDescription: "Info URL:",
            metadataUrlDescriptionTooltip: "Info URL"
        },
        mapStateWidget: {
