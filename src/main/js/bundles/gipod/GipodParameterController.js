...
//                    }
                ...
                _updateNodes: function () {
                    ...
                    if(this.lastQueryOptions && JSON.stringify(this.queryOptions.eventType) == JSON.stringify(this.lastQueryOptions.eventType))
                    if(this.lastQueryOptions && this.lastQueryOptions.workassignment == this.queryOptions.workassignment && this.lastQueryOptions.manifestation == this.queryOptions.manifestation)
                    if(this.lastparameters && this.lastparameters.startdate == qo.startdate && this.lastparameters.enddate == qo.enddate)
                           return;
                    this.lastparameters = qo;
                    this.lastQueryOptions=d_lang.clone(this.queryOptions);
