...
define([
    ...
    function (
        ...
        var exports = {};
        return exports.TiledWebMercatorLayer = declare([TiledMapServiceLayer], {
            ...
            getTileUrl: function (
                ...
                return this.tileServers[row % this.serversLength] + "/" + zoom + "/" + col + "/" + row + ".png";
            }
