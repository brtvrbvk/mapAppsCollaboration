define([
    ...
    function (
         ...
         */
        return _moduleRoot.ExtraInfoWidget = declare([
                _WidgetBase,
                _TemplatedMixin
            ],
            {
                ...
                postCreate: function (evt) {
                    ...
                    if (has("ie")) {
                        this.attributeNameBox.on('mousedown', d_lang.hitch(this, function (e) {
                    ...
                    if (has("ie")) {
                        this.attributeValueBox.on('mousedown', d_lang.hitch(this, function (e) {
                ...
                setInfoContent: function (item) {
                    ...
                    if (this.attributeValueBox) {
                        this.attributeValueBox.set("value", item.description);
                    }
                },
